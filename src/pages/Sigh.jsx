...
export function Sigh( {setCurrentPage} ) {
    return (
        <div className="flex flex-col h-screen text-center pb-12 w-screen px-3 sm:px-[18px] lg:px-[60px] py-6 xl:py-11">
            ...
            <TextBox>
                ...
                <p>
                    ...
                    <br /><br />
                    If such were to happen, our Sire would have to be shut down in order to healthily refresh Timmy. Although it wouldn’t be permanent, it would cut out most communications, leading to a global disturbance. This is exactly why our precautions are excessive.”
                    <br /><br />
