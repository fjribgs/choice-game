        ...
        <div id="haughtyCortex"
            ...
            <TextBox>
                ...
                <p>
                    ...
                    <br /><br />
                    CORTEX SYSTEM: “ I see … The Microglia you exclusively attacked didn’t bring guns of their own, and instead attempted to flee and bring the Axons with them? <NextButton onClick={() => setCurrentPage('why')} text='Why?"'/>
