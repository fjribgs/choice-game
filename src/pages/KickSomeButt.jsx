...
export function KickSomeButt( {setCurrentPage, isNothingVisited, setIsNothingVisited, isOpenPhoneVisited, setIsOpenPhoneVisited } ) {
    return (
        <div className="flex flex-col h-screen text-center w-screen pb-12 px-3 sm:px-[18px] lg:px-[60px] py-6 xl:py-11">
            ...
            <TextBox>
                ...
                <p>
                    <span className={`${(isNothingVisited || isOpenPhoneVisited) ? "hidden" : ""}`}>“Our current arsenal, though amply prepared, I feel will be better at your lead. Hence, the lineup of neurons you see here behind me. We need all of you to fight for Axon strands harder than ever.
                    <br /><br />
